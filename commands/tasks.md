...
5. **Generate tasks.md**: Use `templates/tasks/tasks-template.md` as structure, fill with:
...
7. **Check for extension hooks**: After tasks.md is generated, check if `.cadre/extensions.yml` exists in the project root.
